  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          // En-tete
          const Header("Ajouter une vente"),
            ...
            builder: (context, appState, _) => Column(
              ...
              children: [
                ...
                if (appState.loginState == ApplicationLoginState.loggedIn) ...[
                  const Header('Sélectionner le statut de la vente'),
                  YesNoSelection(
                    state: appState.attending,
                    onSelection: (attending) => appState.attending = attending,
                  ),
                  const Header('Rentrer votre recette (en €)'),
                  GuestBook(
                    addMessage: (message) =>
...
/**
Classe pour renseigner la recette
 */
...
/**
Classe pour le statut de la vente
 */
